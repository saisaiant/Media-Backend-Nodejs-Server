...
module.exports = (express, passport) => {
    ...
    router.post('/product/create', passport.authenticate('jwt', {
        session: false
    }), (req, res) => {
        let obj = {
    ...
    router.get('/product/paginate/:start/:count', passport.authenticate('jwt', {
        session: false
    }), (req, res) => {
    ...
    router.get('/cat/all', passport.authenticate('jwt', {
        session: false
    }), (req, res) => {
        Cat.all()
            .then(result => res.json({
    ...
    router.get('/gallery/all', passport.authenticate('jwt', {
        session: false
    }), (req, res) => {
        Gallery.all()
            .then(result => res.json({
